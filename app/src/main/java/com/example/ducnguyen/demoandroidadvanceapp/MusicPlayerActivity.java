...
public class MusicPlayerActivity extends AppCompatActivity
        implements View.OnClickListener, MusicPlayerService.OnPlaybackStatusChangeListener,
    ...
    private void setUpPlayPauseImage(boolean isPlaying) {
        if (isPlaying) {
            mImagePlayPause.setImageResource(R.drawable.ic_pause_music);
            mObjectAnimator.resume();
        }
        else {
            mImagePlayPause.setImageResource(R.drawable.ic_play_music);
